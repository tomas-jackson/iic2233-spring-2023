...
def buscar_archivo(carpeta: dict, nombre_archivo: str) -> list:
    ...
    if carpeta['subcarpeta_1']:
        if buscar_archivo(carpeta['subcarpeta_1'], nombre_archivo):
            return [carpeta['nombre_carpeta']] + buscar_archivo(carpeta['subcarpeta_1'], nombre_archivo)
    if carpeta['subcarpeta_2']:
        if buscar_archivo(carpeta['subcarpeta_2'], nombre_archivo):
            return [carpeta['nombre_carpeta']] + buscar_archivo(carpeta['subcarpeta_2'], nombre_archivo)
